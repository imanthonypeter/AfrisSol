    ...
    <div className="h-full flex flex-col overflow-y-auto" style={{ background: "#F5F7FA" }}>
        ...
        <div className="text-center mb-2">
          ...
          {balanceVisible ? (
            <div className="flex items-baseline justify-center gap-2">
              <span className="text-white" style={{ fontSize: "34px", fontWeight: 700 }}>25.750,00</span>
              <span className="text-white/70 text-lg">MT</span>
            </div>
          ) : (
            <span className="text-white" style={{ fontSize: "34px", fontWeight: 700 }}>••••••</span>
          )}
        </div>
        ...
        >
          ...
          <div className="relative flex items-end justify-between">
            <div>
              ...
              <p className="text-white text-sm" style={{ fontWeight: 600, letterSpacing: "0.5px" }}>JOÃO MACUÁCUA</p>
            </div>
      ...
      <div className="px-5 mb-5">
        ...
        <div className="flex flex-col gap-2">
          {[
            { label: "Conta principal", num: "MZ 1234 5678 9012", balance: "25.750,00 MT", color: "#162456" },
            { label: "Poupança", num: "MZ 9876 5432 1098", balance: "10.000,00 MT", color: "#F47C20" },
          ].map((acc) => (
            <div
              key={acc.label}
